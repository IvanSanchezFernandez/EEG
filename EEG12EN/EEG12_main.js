...
function checkQ5() {
	...
	if (document.question5.question.value == "b") {
		...
		document.getElementById("afterQ5_picture").innerHTML = "Unfortunately, in certain environments where the use of the term 'seizure disorder' is common you will find many patients on antiseizure medications (sometimes for years) when they never needed them because all they had was a provoked seizure (or several provoked seizures); you will also find find patients with epilepsy whose antiseizure medications are discontinued prematurely if they did not have seizures recently. In summary, the use of the term 'seizure disorder' is not neutral. It harms patients. Learn how to use proper terminology and its treatment implications so that you treat patients appropriately. Take the time to take a proper history, determine if the event is a seizure; determine if the seizure is provoked or unprovoked; determine if the patient has epilepsy; it takes time, but it is the only way to properly treat your patients. 'Seizure disorder' is just a marker of cutting corners and poor medicine.<br><br>Great job!";
